  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
      <div className="max-w-2xl">
        <h1 className="text-3xl md:text-4xl font-extrabold text-foreground">Contact Us</h1>
        <p className="text-muted-foreground mt-3 text-lg">Have a question? Fill in the form and our team will get back to you.</p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 mt-10">
        {/* Info panel */}
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-gradient-to-br from-blue-700 to-indigo-700 text-primary-foreground rounded-2xl p-7">
        ...
        {/* Form */}
        <div className="lg:col-span-3 bg-card rounded-2xl border border-border shadow-sm p-7">
          {submitted ? (
            <div className="text-center py-10">
              ...
              <p className="text-muted-foreground mt-2 max-w-sm mx-auto">Thank you for reaching out. Our team will get back to you within one working day.</p>
              <button type="button" onClick={() => { setForm(EMPTY); setSubmitted(false); }} className="mt-6 text-sm font-semibold text-primary hover:underline">
                Send another enquiry
              </button>
            </div>
          ) : (
            <form onSubmit={submit} className="space-y-5">
              {error && <div className="rounded-lg bg-destructive/10 border border-destructive/20 text-destructive text-sm px-4 py-3">{error}</div>}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-input bg-input-background px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-ring/40"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-input bg-input-background px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-ring/40 resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                disabled={sending}
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-primary text-primary-foreground font-semibold hover:bg-primary/90 transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
